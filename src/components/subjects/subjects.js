    ...
    const handleDelete = (id) => {
      ...
      .then(response => {
        if (response.ok) {
          ...
          const updatedSubjects = subjects2.filter(subject => subject.id !== id);
              ...
              <ul className="list">
                ...
                <div style={styles.subjectrightsidebar}>
                    <div style={{ marginTop:150, marginLeft: 75, marginRight: 75, display:'flex', justifyContent: 'space-between'}}>
                        <button onClick={() => setShowAddSubjectModal(true)} style={styles.registerstudent}>Add Subjects<FontAwesomeIcon style={{marginLeft: 30, color: 'white'}} icon={faPlus} /></button>
                        <div className={`modal ${showAddSubjectModal ? 'modal-open' : 'modal-close'}`}>
                        <div className="modal-content">
                        <FontAwesomeIcon className="close" style={{width: 35, height:35}} icon={faClose} onClick={() => setShowAddSubjectModal(false)} />
                            <div>
                            <h1 style={{textAlign:'center', fontFamily: 'Poppins'}}>ADD SUBJECT</h1>
                            <div className="input-row">
                                <div className="input-col">
                                    <h2>Subject Id</h2>
                                    <input type="number" value={subjectFormData.id} name="id" onChange={handleSubjectFormChange} />
                                </div>
                                <div className="input-col">
                                    <h2>Subject Code</h2>
                                    <input type="text" value={subjectFormData.subjectcode} name="subjectcode" onChange={handleSubjectFormChange} />
                                </div>
                                <div className="input-col">
                                    <h2>Subject Name</h2>
                                    <input type="text" value={subjectFormData.subjectname} name="subjectname" onChange={handleSubjectFormChange} />
                                </div>
                            </div>
                            <div className="input-row">
                                <div className="input-col">
                                    <h2>Instructor Name</h2>
                                    <input type="text" value={subjectFormData.instructorname} name="instructorname" onChange={handleSubjectFormChange} />
                                </div>
                                <div className="input-col">
                                    <h2>Schedule</h2>
                                    <input type="text" value={subjectFormData.schedule} name="schedule" onChange={handleSubjectFormChange} />
                                </div>
                            </div>
                            <div className="button-container">
                    ...
                    <div style={{alignItems:'center', justifyContent:'center', marginLeft:'5%', display:'flex', marginTop:'5%', marginRight:'5%'}}>
                    <table className="my-table2">
                        ...
                        <tr key={subject.id}>
                            ...
                            <td style={{textAlign:'center'}}><FontAwesomeIcon className="sidebar-icon" style={{color: 'red', width:25, height:25, cursor:'pointer'}} icon={faSquareMinus} onClick={() => handleDelete(subject.id)} /></td>
                        </tr>
                        ))}
                        </tbody>
                        </table>
